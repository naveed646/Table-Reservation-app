...
function MainContent() {
  return (
    <>
      ...
      <p className="text-center p-2 rounded-2xl opacity-80 max-w-2xl mx-auto text-lg mb-12 leading-relaxed">
        At <span className="font-semibold  text-black ">קเєςє ๏ภ קlคtє</span>,
