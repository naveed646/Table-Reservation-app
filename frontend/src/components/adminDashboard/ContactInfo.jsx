...
export default function ContactInfo() {
  ...
  return (
    <div className="max-w-xl mx-auto p-6">
      <h1 className="text-2xl font-bold mb-4">Edit Contact Information</h1>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button type="submit" className="bg-black hover:bg-zinc-600 cursor-pointer text-white py-2 px-4 rounded">Save</button>
      </form>
    </div>
  );
}
